/*
resource "aws_db_parameter_group" "default-postgres11" {
    #name        = "default${local.family}${var.common_tags["partner"]}"
    family      = local.family
...
resource "aws_db_parameter_group" "replica" {
    ...
    #name        = "default${local.family}-replica"
    family      = local.family
    description = "Default parameter group for postgres11 ${var.common_tags["partner"]}"
